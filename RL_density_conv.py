...
"""
NAME = "RL_density_initialisation"
...
class DQN (torch.nn.Module):
    ...
    def __init__ ( self:              Self,
        ...
        self.linear2 = torch.nn.Linear(1024, actions_dimension)                          
                                        
        self.bn1 = torch.nn.BatchNorm2d(self.channels)

        self.conv1 = conv_max(self.channels,64,1)
        self.conv2 = conv_mean(64,128,1)
        self.conv3 = conv_mean(128,256,1)
        self.conv4 = conv_mean(256,512,1)
